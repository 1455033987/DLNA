...
public class MainActivity extends AppCompatActivity implements DLNADeviceConnectListener {
    ...
    private DLNAControlCallback callback = new DLNAControlCallback() {
        @Override
        ...
        public void onReceived(@Nullable ActionInvocation invocation, @Nullable Object... extra) {
            Log.d("invocation",invocation.toString());
            Log.d("extra1",extra.toString());
    ...
    public boolean onKeyDown(int key, KeyEvent event){
        ...
        switch (key){
            case KeyEvent.KEYCODE_VOLUME_UP:
                ...
                mAudioManager.setStreamVolume(AudioManager.STREAM_MUSIC, mCurrentVolume, AudioManager.FLAG_SHOW_UI);
                mDLNAPlayer.setVolume(mCurrentVolume,callback);
                return true;
